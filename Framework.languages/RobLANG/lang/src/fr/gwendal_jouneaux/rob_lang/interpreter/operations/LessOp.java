...
@Operationalize(node = Less.class, visitor = "fr.gwendal_jouneaux.rob_lang.interpreter.RobLANGVisitor")
public class LessOp extends Operation<Less> {

	@Override
	public Object execute(SelfAdaptiveVisitor vis, Less e, Object execCtx) {
