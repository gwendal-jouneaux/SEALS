...
@Operationalize(node = GreaterEq.class, visitor = "fr.gwendal_jouneaux.rob_lang.interpreter.RobLANGVisitor")
public class GreaterEqOp extends Operation<GreaterEq> {

	@Override
	public Object execute(SelfAdaptiveVisitor vis, GreaterEq e, Object execCtx) {
