...
@Operationalize(node = LessEq.class, visitor = "fr.gwendal_jouneaux.rob_lang.interpreter.RobLANGVisitor")
public class LessEqOp extends Operation<LessEq> {

	@Override
	public Object execute(SelfAdaptiveVisitor vis, LessEq e, Object execCtx) {
