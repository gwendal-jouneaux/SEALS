...
@Operationalize(node = InferiorOrEqual.class, visitor = "miniJava.interpreter.MiniJavaVisitor")
public class InferiorOrEqualOp extends Operation<InferiorOrEqual>{

	@Override
	public Object execute(SelfAdaptiveVisitor vis, InferiorOrEqual node, Object execCtx) {
		Value result;
