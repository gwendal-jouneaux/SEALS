...
@Operationalize(node = SuperiorOrEqual.class, visitor = "miniJava.interpreter.MiniJavaVisitor")
public class SuperiorOrEqualOp extends Operation<SuperiorOrEqual>{

	@Override
	public Object execute(SelfAdaptiveVisitor vis, SuperiorOrEqual node, Object execCtx) {
		Value result;
