...
@Operationalize(node = Equality.class, visitor = "miniJava.interpreter.MiniJavaVisitor")
public class EqualityOp extends Operation<Equality>{

	@Override
	public Object execute(SelfAdaptiveVisitor vis, Equality node, Object execCtx) {
		Value result;
