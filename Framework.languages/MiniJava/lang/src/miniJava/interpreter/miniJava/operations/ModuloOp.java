...
@Operationalize(node = Modulo.class, visitor = "miniJava.interpreter.MiniJavaVisitor")
public class ModuloOp extends Operation<Modulo>{

	@Override
	public Object execute(SelfAdaptiveVisitor vis, Modulo node, Object execCtx) {
		Value result;
		...
		if (left instanceof IntegerValue) {
			if (right instanceof IntegerValue) {
				...
				tmp.setValue(MathService.mod((Modulo) (node), (int) (bleft.getValue()), (int) (bright.getValue())));
				result = (Value) (tmp) ;
			}
			else {
				result = (Value) (null) ;
