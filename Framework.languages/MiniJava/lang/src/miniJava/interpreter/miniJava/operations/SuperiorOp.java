...
@Operationalize(node = Superior.class, visitor = "miniJava.interpreter.MiniJavaVisitor")
public class SuperiorOp extends Operation<Superior>{

	@Override
	public Object execute(SelfAdaptiveVisitor vis, Superior node, Object execCtx) {
		Value result;
