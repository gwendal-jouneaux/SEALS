...
@Operationalize(node = Division.class, visitor = "miniJava.interpreter.MiniJavaVisitor")
public class DivisionOp extends Operation<Division>{

	@Override
	public Object execute(SelfAdaptiveVisitor vis, Division node, Object execCtx) {
		Value result;
