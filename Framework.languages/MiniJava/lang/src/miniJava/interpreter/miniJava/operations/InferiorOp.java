...
@Operationalize(node = Inferior.class, visitor = "miniJava.interpreter.MiniJavaVisitor")
public class InferiorOp extends Operation<Inferior>{

	@Override
	public Object execute(SelfAdaptiveVisitor vis, Inferior node, Object execCtx) {
		Value result;
