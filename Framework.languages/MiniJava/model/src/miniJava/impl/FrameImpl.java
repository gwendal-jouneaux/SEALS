 ...
 * </p>
 * <ul>
 *   <li>{@link miniJava.impl.FrameImpl#getCall <em>Call</em>}</li>
 *   <li>{@link miniJava.impl.FrameImpl#getInstance <em>Instance</em>}</li>
 *   <li>{@link miniJava.impl.FrameImpl#getChildFrame <em>Child Frame</em>}</li>
 *   <li>{@link miniJava.impl.FrameImpl#getParentFrame <em>Parent Frame</em>}</li>
 *   <li>{@link miniJava.impl.FrameImpl#getRootContext <em>Root Context</em>}</li>
 *   <li>{@link miniJava.impl.FrameImpl#getReturnValue <em>Return Value</em>}</li>
 * </ul>
 *
 * @generated
 */
