...
public class RobLANGPackageImpl extends EPackageImpl implements RobLANGPackage
{
   ...
   */
  @Override
  public EAttribute getAnnotatedStatement_Property()
  {
    return (EAttribute)annotatedStatementEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getAnnotatedStatement_LowerBound()
  {
   ...
   */
  @Override
  public EReference getAnnotatedStatement_HigherBound()
  {
    return (EReference)annotatedStatementEClass.getEStructuralFeatures().get(2);
  }
  ...
  {
    return (EReference)annotatedStatementEClass.getEStructuralFeatures().get(3);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(annotatedStatementEClass, ANNOTATED_STATEMENT__PROPERTY);
    createEReference(annotatedStatementEClass, ANNOTATED_STATEMENT__LOWER_BOUND);
    createEReference(annotatedStatementEClass, ANNOTATED_STATEMENT__HIGHER_BOUND);
  ...
  public void initializePackageContents()
  {
    ...
    printExpressionEClass.getESuperTypes().add(this.getSimpleStatement());
    loopEClass.getESuperTypes().add(this.getSimpleStatement());
    conditionEClass.getESuperTypes().add(this.getSimpleStatement());
    returnEClass.getESuperTypes().add(this.getSimpleStatement());
    breakEClass.getESuperTypes().add(this.getSimpleStatement());
    expressionEClass.getESuperTypes().add(this.getSimpleStatement());
    arrayExpressionEClass.getESuperTypes().add(this.getExpression());
    arrayStatementEClass.getESuperTypes().add(this.getSimpleStatement());
    ...
    effectorEClass.getESuperTypes().add(this.getSimpleStatement());
    ...
    initEAttribute(getAnnotatedStatement_Property(), this.getAdaptationProperty(), "property", null, 0, 1, AnnotatedStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getAnnotatedStatement_LowerBound(), this.getExpression(), null, "lowerBound", null, 0, 1, AnnotatedStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getAnnotatedStatement_HigherBound(), this.getExpression(), null, "higherBound", null, 0, 1, AnnotatedStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getAnnotatedStatement_Statement(), this.getSimpleStatement(), null, "statement", null, 0, 1, AnnotatedStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    addEEnumLiteral(adaptationPropertyEEnum, AdaptationProperty.TIME);
    addEEnumLiteral(adaptationPropertyEEnum, AdaptationProperty.ENERGY);
