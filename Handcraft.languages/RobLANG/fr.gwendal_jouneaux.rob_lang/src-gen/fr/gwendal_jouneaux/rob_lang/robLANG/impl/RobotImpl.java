 ...
 * </p>
 * <ul>
 *   <li>{@link fr.gwendal_jouneaux.rob_lang.robLANG.impl.RobotImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.gwendal_jouneaux.rob_lang.robLANG.impl.RobotImpl#getFunctions <em>Functions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RobotImpl extends MinimalEObjectImpl.Container implements Robot
{
  ...
  {
    return RobLANGPackage.Literals.ROBOT;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RobLANGPackage.ROBOT__NAME, oldName, name));
  }
  ...
  public EList<FunDefinition> getFunctions()
  {
    if (functions == null)
    {
      functions = new EObjectContainmentEList<FunDefinition>(FunDefinition.class, this, RobLANGPackage.ROBOT__FUNCTIONS);
    }
    return functions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RobLANGPackage.ROBOT__FUNCTIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RobLANGPackage.ROBOT__NAME:
        return getName();
      case RobLANGPackage.ROBOT__FUNCTIONS:
        return getFunctions();
    }
