...
public class SuperiorOperationImpl extends ExpressionOperationImpl implements SuperiorOperation {
	private final Superior it;

	private final VisitorInterface vis;

	public SuperiorOperationImpl(Superior it, VisitorInterface vis) {
		super(it, vis);
		this.it = it;
		this.vis = vis;
	}
