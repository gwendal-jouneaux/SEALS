...
public class EqualityOperationImpl extends ExpressionOperationImpl implements EqualityOperation {
	private final Equality it;

	private final VisitorInterface vis;

	public EqualityOperationImpl(Equality it, VisitorInterface vis) {
		super(it, vis);
		this.it = it;
		this.vis = vis;
	}
