 ...
 * </p>
 * <ul>
 *   <li>{@link miniJava.impl.StateImpl#getRootFrame <em>Root Frame</em>}</li>
 *   <li>{@link miniJava.impl.StateImpl#getObjectsHeap <em>Objects Heap</em>}</li>
 *   <li>{@link miniJava.impl.StateImpl#getOutputStream <em>Output Stream</em>}</li>
 *   <li>{@link miniJava.impl.StateImpl#getArraysHeap <em>Arrays Heap</em>}</li>
 *   <li>{@link miniJava.impl.StateImpl#getContextCache <em>Context Cache</em>}</li>
 *   <li>{@link miniJava.impl.StateImpl#getFrameCache <em>Frame Cache</em>}</li>
 * </ul>
 *
 * @generated
 */
