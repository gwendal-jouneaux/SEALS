...
public class MultiplicationOperationImpl extends ExpressionOperationImpl implements MultiplicationOperation {
	private final Multiplication it;

	private final VisitorInterface vis;

	public MultiplicationOperationImpl(Multiplication it, VisitorInterface vis) {
		super(it, vis);
		this.it = it;
		this.vis = vis;
	}
