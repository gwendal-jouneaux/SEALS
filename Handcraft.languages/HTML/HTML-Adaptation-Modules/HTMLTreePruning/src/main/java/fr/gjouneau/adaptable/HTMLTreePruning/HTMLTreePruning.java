...
@Registration(id = HTMLTreePruning.ID, name = "HTML Tree Pruning", version = "0.1", services = HTMLTreePruning.class)
public class HTMLTreePruning extends TruffleAdaptableModule<HTMLAdaptationContext, HTMLLanguage> {
	...
	@Option(name = "", help = "Enable tree pruning (default: false).", category = OptionCategory.USER, stability = OptionStability.STABLE)
    static final OptionKey<Boolean> ENABLED = new OptionKey<Boolean>(false);
	
	@Override
    protected OptionDescriptors getOptionDescriptors() {
        return new HTMLTreePruningOptionDescriptors();
    }
