...
@SupportedAnnotationTypes(value = { "fr.gjouneau.savm.framework.lang.semantics.Operationalize" })
...
public class OperationalizationProcessor extends AbstractProcessor {
	...
	private void generateVisitorClass(String visitorFQN, Map<Element, TypeElement> visitorOperations) throws IOException {
		...
		TypeElement nodeType = processingEnv.getElementUtils().getTypeElement("fr.gjouneau.savm.framework.lang.semantics.Node");
		TypeElement adaptableNodeType = processingEnv.getElementUtils().getTypeElement("fr.gjouneau.savm.framework.lang.semantics.AdaptableNode");
		
		String classname = visitorFQN.substring(visitorFQN.lastIndexOf(".")+1);
		String pkg = visitorFQN.substring(0, visitorFQN.lastIndexOf("."));
		
		classfile.append("package "+pkg+";\n\npublic class "+classname+" implements fr.gjouneau.savm.framework.lang.semantics.SelfAdaptiveVisitor {\n");
		...
		classfile.append("\tpublic Object dispatch(fr.gjouneau.savm.framework.lang.semantics.Node node, Object executionCtx){\n");
		classfile.append(generateDispatch(adaptableNodeType, inheritance).toString());
		classfile.append("\t\treturn null;\n\t}\n");
		classfile.append("\tpublic Object dispatch(fr.gjouneau.savm.framework.lang.semantics.AdaptableNode node, Object executionCtx, fr.gjouneau.savm.framework.lang.semantics.SemanticsAdaptationInterface config){\n");
